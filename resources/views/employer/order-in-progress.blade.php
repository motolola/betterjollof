            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <hr>
                    ...
                    <fieldset>
                     <legend>Order in Progress</legend>
                     <p class="text-danger">You have already placed a normal order for this payroll period and cannot place another.</p>
                        ...
                        <form method="POST" action="{{url('employer/place-order')}}"> 
                          ...
                          <div class="form-group">
                                ...
                                <input type="radio" class="form-control" name="order_type" {{ ($order_types->placed == 1) ? ' disabled ': '' }} id="field1" value="Standard" placeholder="example">
                          ...
                          <div class="form-group text-right">
                            <button role="button" type="submit" class="btn btn-primary">Continue to Edit Order</button>
                          </div>
                        </form>
