                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <h1>
                                            <i class="fa fa-list-ul" aria-hidden="true"></i> Order(s) made to you.
                                            <a href="{{url('order/received-history')}}" class="btn btn-primary">View History</a>
                                        </h1>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('order/received-details/'.$order->id)}}">
                                                            <button class="btn btn-sm btn-primary">View Details <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                            </button>
                                                        </a>
                                                    </td>
                                                </tr>
