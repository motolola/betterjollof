<form class="form" role="form" method="POST" action="{{ url('user/beneficiary-registration')}}">
  <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group{{ $errors->has('ni_number') ? ' has-error' : '' }}">
                ...
                <input id="ni_number" type="ni" class="form-control" name="ni_number" value="{{ old('ni_number') }}">
