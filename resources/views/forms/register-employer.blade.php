<form class="form" role="form" method="POST" action="{{ route('store-employer') }}">
    <div class="row">
            ...
            <section>
                <fieldset>
                    ...
                    <div class="form-group{{ $errors->has('account.email') ? ' has-error' : '' }}">
                        ...
                        <input id="account_email" type="email" class="form-control" name="account[email]" value="{{ old('account.email') }}">
                        @if ($errors->has('account.email'))
                          <div class="help-block cs-error">{{ $errors->first('account.email') }}</div>
                        @endif
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('account.password') ? ' has-error' : '' }}">
                        ...
                        <input id="account_password" type="password" class="form-control" name="account[password]" value="{{ old('account.password') }}">
                        @if ($errors->has('account.password'))
                          <div class="help-block cs-error">{{ $errors->first('account.password') }}</div>
                        @endif
                    </div>

                    <div class="form-group{{ $errors->has('account.password_confirm') ? ' has-error' : '' }}">
                        <label for="account_password_confirm" class="control-label">Confirm Password</label>
                        <input id="account_password_confirm" type="password" class="form-control" name="account[password_confirm]" value="{{ old('account.password_confirm') }}">
                        @if ($errors->has('account.password_confirm'))
                          <div class="help-block cs-error">{{ $errors->first('account.password_confirm') }}</div>
                        @endif
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="checkbox{{ $errors->has('client[privacy_agreed]') ? ' has-error' : '' }}">
                        <label>
                            <input type="checkbox" id="privacy_agreed" name="client[privacy_agreed]">
                            I agree with the <a href="#" title="Privacy policy link">Privacy policy</a>
                        </label>
                    </div>
                    <div class="checkbox{{ $errors->has('client[marketing_agreed]') ? ' has-error' : '' }}">
                        <label>
                            <input type="checkbox" id="marketing_agreed" name="client[marketing_agreed]">
